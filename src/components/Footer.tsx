  ...
  <footer className="border-t border-border py-12">
    <div className="container mx-auto px-4">
      <div className="grid md:grid-cols-3 gap-8 mb-8">
        <div>
          <h3 className="text-gradient-gold font-heading text-xl font-bold mb-4">LOURENÇO MOTORS</h3>
          <p className="text-muted-foreground text-sm leading-relaxed">
            Compra, venda, troca, consignação, consultoria e importação automóvel há mais de 30 anos.
          </p>
        </div>
        <div>
          <h4 className="font-semibold text-sm uppercase tracking-wide mb-4">Contactos</h4>
        ...
        <div>
          <h4 className="font-semibold text-sm uppercase tracking-wide mb-4">Redes Sociais</h4>
