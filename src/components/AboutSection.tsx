  ...
  <section id="sobre" className="py-20 md:py-28 bg-card">
    <div className="container mx-auto px-4">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <p className="text-primary text-sm tracking-[0.3em] uppercase mb-3">Quem Somos</p>
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">
            Mais de <span className="text-gradient-gold">30 Anos</span> de Confiança
          </h2>
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <div key={item.label} className="flex flex-col items-center gap-2 p-4 rounded-lg bg-secondary">
